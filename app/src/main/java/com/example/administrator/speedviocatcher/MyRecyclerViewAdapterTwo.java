...
public class MyRecyclerViewAdapterTwo extends RecyclerView
        .Adapter<MyRecyclerViewAdapterTwo
        .DataObjectHolder> {
    ...
    public MyRecyclerViewAdapterTwo(ArrayList<DataObject> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_view_rowtwo, parent, false);
