...
public class ScanningDevice extends Activity implements Bluetooth.DiscoveryCallback, AdapterView.OnItemClickListener{
    ...
    public void onFinish() {
        ...
        setText("ScanningDevice finished!");
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    public void onPair(BluetoothDevice device) {
        ...
        setProgressVisibility(View.INVISIBLE);
        setText("Paired!");
        Intent i = new Intent(ScanningDevice.this, SelectVehicle.class);
        startActivity(i);
        finish();
    }
